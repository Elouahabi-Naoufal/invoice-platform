...
export default function InvoicePreview({ doc }: { doc: PreviewDoc }) {
  ...
  return (
    <div className="a4doc w-[600px] max-w-full bg-white text-[13px] leading-relaxed text-ink-950 shadow-doc max-md:w-full print:mx-auto print:w-[700px] print:max-w-[700px] print:shadow-none">
